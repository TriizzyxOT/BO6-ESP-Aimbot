___11/17 UPDATE: We have identified an issue with the loader causing functionality issues on newer versions of Windows 10 and Windows 11. Windows 10 version 24h2 has a conflict with the inital startup with the loader. To remedy this, we will be implementing an update later this week addressing this conflict. Windows 10 versions 22h2 and 23h2 ARE CONFIRMED WORKING CORRECTLY. Currently the loader will not run on Win10/11 Version 24h2, so if you are having functionality issues please check your Windows version before opening an issue on Github.</br>
